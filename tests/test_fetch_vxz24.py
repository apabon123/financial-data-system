#!/usr/bin/env python
"""
Test script to fetch data for VXZ24 with different intervals.
"""
...
TEST_DB_PATH = os.path.join(project_root, "data", "test_financial_data.duckdb")

def test_fetch_vxz24():
    """Test fetching data for VXZ24 with different intervals."""
